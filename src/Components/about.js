	...
	render(){
		const desktop = (
			<DesktopAbout>
						...
						<h2 class="prof-header">Sean Yoon, Co-founder and CEO</h2>
						...
						<h2 class="prof-header">Nishant Kumar, Co-founder and CTO</h2>
						<p class="prof-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut
							labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip
							ex ea commodo consequat.</p><br/>
						...
						<p class="prof-text">Daniel is originally from Cleveland, Ohio and now studies Computer Science and Finance at Duke University.
							He enjoys golf, fitness and reading. He's also a huge Billy Joel fan!</p><br/>

						<img src={will} alt="" class="rightpic" />
						<h2 class="prof-header">Will Sheehan, Software Development Team</h2>
						<p class="prof-text">Will is originally from Hawaii and currently lives in Austin, Texas. Will studies Computer Science and Decision
							Sciences at Duke University. He enjoys spending time outdoors and reading fantasy novels. He has two younger siblings, and a dog named Koda.</p><br/>

						<img src={christine} alt="" class="leftpic" />
						<h2 class="prof-header">Christine Hwang, Software Development Team</h2>
